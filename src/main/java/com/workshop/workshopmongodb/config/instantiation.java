...
public class instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Boa viagem mano!", sdf.parse("21/01/2021"), new AuthorDTO(alex));
        CommentDTO c2 = new CommentDTO("Aproveite", sdf.parse("22/01/2021"), new AuthorDTO(bob));
        CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", sdf.parse("23/01/2021"), new AuthorDTO(alex));
