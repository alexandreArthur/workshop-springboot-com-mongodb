package com.workshop.workshopmongodb.resources.exception;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException e, HttpServletRequest re){
        ...
        StandardError err = new StandardError(System.currentTimeMillis(),status.value(), "Não encontrado",e.getMessage(),re.getRequestURI());
